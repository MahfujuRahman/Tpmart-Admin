                            ...
                            <div class="form-group" style="margin-bottom: .5rem;">
                                ...
                                <select name="order_status" class="form-control" required>
                                    ...
                                    <option value="0" @if($order->order_status == 0) selected @endif
                                        @if($order->order_status == 1 || $order->order_status == 2 || $order->order_status == 3 || $order->order_status == 4 || $order->order_status == 5) disabled @endif>Pending</option>
                                    <option value="1" @if($order->order_status == 1) selected @endif
                                        @if($order->order_status == 2 || $order->order_status == 3 || $order->order_status == 4 || $order->order_status == 5) disabled @endif>Approved</option>
                                    <option value="2" @if($order->order_status == 2) selected @endif
                                        @if($order->order_status == 0 || $order->order_status == 3 || $order->order_status == 4 || $order->order_status == 5) disabled @endif>Intransit</option>
                                    <option value="3" @if($order->order_status == 3) selected @endif
                                        @if($order->order_status == 1 || $order->order_status == 0 || $order->order_status == 4 || $order->order_status == 5) disabled @endif>Delivered</option>
                                    <option value="5" @if($order->order_status == 5) selected @endif
                                        @if($order->order_status == 1 || $order->order_status == 0 || $order->order_status == 2 || $order->order_status == 4) disabled @endif>Picked</option>
                                    <option value="4" @if($order->order_status == 4) selected @endif
                                        @if($order->order_status == 2 || $order->order_status == 3 || $order->order_status == 5)
                                        disabled @endif>Cancel</option>
                                </select>
                            </div>
