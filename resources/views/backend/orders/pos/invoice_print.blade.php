...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 10px;
            max-width: 300px; /* 80mm thermal printer width */
            background: white;
        }
...
<body>
    ...
    <div class="customer-info">
        ...
        <div style="margin-top: 5px; font-size: 10px;">
            ...
            @if($order->shippingInfo->city), {{ $order->shippingInfo->city }}@endif
        </div>
        @endif
    </div>
    @endif
    ...
    <div class="items-table">
        ...
        <div class="item-row">
            ...
            <div class="item-details">
                <span>{{ $item->qty }} {{ $item->unit_name ?? 'pc' }} × ৳{{ number_format($item->unit_price, 2) }}</span>
