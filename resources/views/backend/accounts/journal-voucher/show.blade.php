            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('voucher.journal.print', $journalVoucher->id) }}" class="btn btn-info" target="_blank">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Date:</th>
                                    <td>{{ $journalVoucher->trans_date ? (is_string($journalVoucher->trans_date) ? \Carbon\Carbon::parse($journalVoucher->trans_date)->format('d/m/Y') : $journalVoucher->trans_date->format('d/m/Y')) : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Total Amount:</th>
                                ...
                                <tr>
                                    <th>Status:</th>
                                    <td>
                                        <span class="badge badge-{{ ($journalVoucher->status ?? 0) ? 'success' : 'danger' }}">
