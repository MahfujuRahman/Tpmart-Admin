            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('contra-voucher.print', $contraVoucher->id) }}" class="btn btn-info" target="_blank">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Date:</th>
                                    <td>{{ $contraVoucher->trans_date ? (is_string($contraVoucher->trans_date) ? \Carbon\Carbon::parse($contraVoucher->trans_date)->format('d/m/Y') : $contraVoucher->trans_date->format('d/m/Y')) : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Total Amount:</th>
