            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('voucher.receive.print', $receiveVoucher->id) }}" class="btn btn-info" target="_blank">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Date:</th>
                                    <td>{{ $receiveVoucher->trans_date ? (is_string($receiveVoucher->trans_date) ? \Carbon\Carbon::parse($receiveVoucher->trans_date)->format('d/m/Y') : $receiveVoucher->trans_date->format('d/m/Y')) : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Total Amount:</th>
                                ...
                                <tr>
                                    <th>Status:</th>
                                    <td>
                                        <span class="badge badge-{{ ($receiveVoucher->status ?? 0) ? 'success' : 'danger' }}">
